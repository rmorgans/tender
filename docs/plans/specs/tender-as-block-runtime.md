...
| Cross-host execution (`--host` + Win32 Job Objects + SSH) | Manage container/VM lifecycles (boundary metadata describes only — see [boundary-metadata](../backlog/boundary-metadata.md)) |
