...
Items 1–3 and 6 have shipped; item 5's callback delivery now flows through the event stream (see the item). Items 4 and 7 remain unbuilt read/stream conveniences. Item 8 is a new crate; isolates libghostty's footprint. Item 9 is downstream.
