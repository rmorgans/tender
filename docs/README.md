...
- [Planning archive](plans/README.md) — the working plan/spec ledger (active queue, backlog, completed history, long-lived specs). Useful for contributors; not a user guide.
